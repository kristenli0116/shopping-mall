...
public class Orders {
//    public Orders(String orderId, String userId, String untitled, String receiverName, String receiverMobile, String receiverAddress, BigDecimal totalAmount, Integer actualAmount, Integer payType, String orderRemark, String status, String deliveryType, String deliveryFlowId, BigDecimal orderFreight, Integer deleteStatus, Date createTime, Date updateTime, Date payTime, Date deliveryTime, Date flishTime, Date cancelTime, Integer closeType) {
